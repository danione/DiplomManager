...
urlpatterns = [
    ...
    url(r'^(?P<student_id>[0-9]+)/handed_assignment_over/redirection/$', RedirectView.as_view(url=reverse_lazy('admin_homepage')), name='handed_assignment_over/redirection'),
    url(r'^(?P<student_id>[0-9]+)/handed_documentation_over/$', views.handed_documentation_over, name='handed_documentation_over'),
    url(r'^(?P<student_id>[0-9]+)/handed_documentation_over/redirection/$', RedirectView.as_view(url=reverse_lazy('admin_homepage')), name='handed_documentation_over/redirection'),
